...
class Face_Recognition_System:
    def __init__(self,root):
        ...
        b2_2 = Button(bg_img,text="Face Recognition",cursor="hand2",command=self.face_data,font=("Times New Roman",15,"bold"),bg="darkblue",fg="white")
        ...
        #button
        b8 = Button(bg_img,image=self.photoimg12,cursor="hand2",command=self.exit_window)
        b8.place(x=1100,y=380,width=220,height=220)

        b8_8 = Button(bg_img,text="Exit",cursor="hand2",command=self.exit_window,font=("Times New Roman",15,"bold"),bg="darkblue",fg="white")
    ...
    def exit_window(self):
        self.exit_window = tkinter.messagebox.askyesno("Face Recognition","Do you want to exit?",parent=self.root)
